...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(html
     clojure
     (go :variables go-tab-width 4 gofmt-command "gofmt")
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-line-numbers '(:visual t
                               :disabled-for-modes dired-mode doc-view-modee pdf-view-mode
                               :siZe-limit-kb 1000)
